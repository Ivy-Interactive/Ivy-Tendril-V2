...
export function recommendation(overrides: Partial<RecommendationItem> = {}): RecommendationItem {
  return {
...
export function bridgeError(overrides: Partial<BridgeError> = {}): BridgeError {
  return {
    ...
    message:
      "Failed to set recommendation 'Tauri WebDriver E2E Automation' to Accepted (404 Not Found)",
