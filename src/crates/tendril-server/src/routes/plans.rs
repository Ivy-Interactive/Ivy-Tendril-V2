...
use tendril_core::plans::{
    ...
    get_revision, list_plan_verifications, list_recommendations, read_diff_comments,
    read_plan_file, read_plan_yaml, remove_diff_comment, remove_plan_verification,
    remove_recommendation, resolve_plan_folder, resolve_plan_folder_name,
