...
>(
  (
    ...
    // No keyboard shortcut is bound here - a consumer can bind its own to `toggleSidebar` (#245).
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-2 text-xs font-medium tabular-nums text-inherit select-none pointer-events-none",
        "peer-data-[size=sm]/menu-button:top-1",
        "peer-data-[size=default]/menu-button:top-1.5",
        "peer-data-[size=lg]/menu-button:top-2.5",
        "group-data-[collapsible=icon]:absolute group-data-[collapsible=icon]:-top-1 group-data-[collapsible=icon]:-right-1 group-data-[collapsible=icon]:inline-flex group-data-[collapsible=icon]:h-4 group-data-[collapsible=icon]:min-w-4 group-data-[collapsible=icon]:px-1 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:rounded-full group-data-[collapsible=icon]:bg-primary group-data-[collapsible=icon]:text-2xs group-data-[collapsible=icon]:font-medium group-data-[collapsible=icon]:leading-none group-data-[collapsible=icon]:tabular-nums group-data-[collapsible=icon]:font-sans group-data-[collapsible=icon]:text-primary-foreground group-data-[collapsible=icon]:select-none",
        className,
      )}
      {...props}
    />
