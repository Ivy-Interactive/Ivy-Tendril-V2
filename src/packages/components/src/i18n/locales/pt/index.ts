/**
 * The Brazilian Portuguese catalogs, one export per namespace. `../../register.ts` loads this
 * module on demand, the first time the language is chosen, so it is a chunk of its own rather than
 * part of every page.
 *
